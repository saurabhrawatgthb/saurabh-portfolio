...
import { BookOpen, Activity, FileText, CheckCircle2, Shield } from "lucide-react";
import { researchData } from "@/data/research";

export function ResearchSection() {
  return (
    <section id="research" className="relative min-h-screen w-full px-4 sm:px-8 md:px-16 py-24 bg-gta-dark text-white font-sans select-none">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4 border-b-4 border-white pb-4 mb-10">
          ...
          <div className="bg-gta-yellow text-black font-pricedown px-4 py-2 text-lg tracking-widest shadow-hard">
            #{researchData.paperCode}
          </div>
        </div>

        {/* Research Paper Card */}
        <div className="bg-gta-cardDark border-4 border-gta-yellow p-6 md:p-10 shadow-hard">
          <div className="border-b-2 border-white/10 pb-6 mb-6">
            ...
            <div className="mt-3 inline-block bg-gta-yellow text-black font-pricedown text-xs px-3 py-1 tracking-wider font-bold">
              STATUS: {researchData.status}
            </div>
          </div>

          {/* Abstract */}
          <div className="bg-black border-l-4 border-gta-pink p-5 mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
            {researchData.systemMetrics.map((metric, idx) => (
              <div key={idx} className="bg-black border-2 border-white/20 p-4 text-center">
